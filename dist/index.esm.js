import require$$0, { useState, useCallback, useEffect, useContext, createContext, useMemo } from 'react';
import { getLogger } from '@qwickapps/logging';
import { useNavigate, Route, Routes } from 'react-router-dom';
import { Divider, Typography, Button, Box, CircularProgress, Link, LinearProgress, FormControlLabel, Checkbox, Alert, Snackbar } from '@mui/material';
import { Login, PersonAdd, Email, Lock, Logout } from '@mui/icons-material';
import { GridLayout, TextField, Button as Button$1, GridCell, FormPage, TextInputField, useQwickApp } from '@qwickapps/react-framework';
import { createClient } from '@supabase/supabase-js';
import { createAuthError, createAuthFailure, createAuthSuccess } from '@qwickapps/auth';
...
var logger$2 = getLogger('AuthProvider');
// Create auth context
...
function AuthProvider(_a) {
  ...
  var authService = useState(function () {
  ...
  // Auth actions
  var signIn = useCallback(function (credentials) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var signUp = useCallback(function (credentials) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var resetPassword = useCallback(function (request) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var updateProfile = useCallback(function (update) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var signInWithProvider = useCallback(function (options) {
    return __awaiter(_this, void 0, void 0, function () {
...
var SocialAuthBlock = function SocialAuthBlock(_a) {
  ...
  return jsxRuntimeExports.jsxs(GridLayout, {
    sx: {
      width: '100%'
    },
    children: [showDivider && jsxRuntimeExports.jsx(Divider, {
      sx: {
        my: 2,
        width: '100%'
      },
...
var LoginForm = function LoginForm(_a) {
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    noValidate: true,
    children: [jsxRuntimeExports.jsxs(GridLayout, {
      spacing: "small",
      columns: 1,
      children: [jsxRuntimeExports.jsx(TextField, {
        ...
        startIcon: loading ? jsxRuntimeExports.jsx(CircularProgress, {
          size: 20
        }) : jsxRuntimeExports.jsx(Login, {}),
        sx: {
          mt: 1
        },
        span: "auto",
        children: loading ? 'Signing In...' : 'Sign In'
      }), showForgotPassword && onForgotPassword && jsxRuntimeExports.jsx(GridCell, {
        span: "grow",
        sx: {
          textAlign: 'center',
          mt: 1
    ...
    }), showSocialLogin && socialProviders.length > 0 && jsxRuntimeExports.jsx(Box, {
      sx: {
        mt: 2
      },
    ...
    }), signUpUrl && jsxRuntimeExports.jsxs(Typography, {
      variant: "body2",
      sx: {
        textAlign: 'center',
        mt: 2
      },
      children: ["Don't have an account?", ' ', jsxRuntimeExports.jsx(Link, {
        href: signUpUrl,
        children: "Sign up"
      })]
    })]
...
var AuthFooterLinks = function AuthFooterLinks(_a) {
  var text = _a.text,
    ...
    _b = _a.sx,
    sx = _b === void 0 ? {} : _b;
  return jsxRuntimeExports.jsxs(Typography, {
    variant: "body2",
    sx: _assign({
      textAlign: 'center',
      mt: 2
    }, sx),
    children: [text, ' ', jsxRuntimeExports.jsx(Link, {
      href: href,
      onClick: onClick,
      sx: {
...
var LoginPage = function LoginPage(_a) {
  ...
  return jsxRuntimeExports.jsx(FormPage, {
    title: title,
...
var RegisterForm = function RegisterForm(_a) {
  ...
  var passwordStrength = useMemo(function () {
  ...
  return jsxRuntimeExports.jsx(Box, {
    ...
    children: jsxRuntimeExports.jsxs(GridLayout, {
      spacing: "2",
      children: [jsxRuntimeExports.jsx(TextInputField, {
        label: "Email Address",
        type: "email",
        value: credentials.email,
        ...
        disabled: loading,
        placeholder: "Enter your email address"
      }), shouldShowNameField && jsxRuntimeExports.jsx(TextInputField, {
        label: "Full Name",
        type: "text",
      ...
      }), jsxRuntimeExports.jsx(TextInputField, {
        label: "Password",
        type: "password",
        value: credentials.password,
        onChange: function onChange(value) {
      ...
      }), passwordStrength && credentials.password && jsxRuntimeExports.jsxs(Box, {
        sx: {
          mt: 1
        },
        children: [jsxRuntimeExports.jsx(LinearProgress, {
          variant: "determinate",
        ...
        }), passwordStrength.feedback.length > 0 && jsxRuntimeExports.jsx(Typography, {
          variant: "caption",
          color: "text.secondary",
          component: "div",
        ...
        label: jsxRuntimeExports.jsxs(Typography, {
          variant: "body2",
          children: ["I agree to the", ' ', termsUrl ? jsxRuntimeExports.jsx(Link, {
            href: termsUrl,
            target: "_blank",
            children: "Terms of Service"
          }) : 'Terms of Service', privacyUrl && jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [' ', "and", ' ', jsxRuntimeExports.jsx(Link, {
              href: privacyUrl,
              target: "_blank",
      ...
      }), validationErrors.terms && jsxRuntimeExports.jsx(Typography, {
        variant: "caption",
        color: "error",
        sx: {
          display: 'block',
      ...
      }), jsxRuntimeExports.jsx(GridCell, {
        span: 12,
        children: jsxRuntimeExports.jsx(Button, {
          ...
          startIcon: loading ? jsxRuntimeExports.jsx(CircularProgress, {
            size: 20
          }) : jsxRuntimeExports.jsx(PersonAdd, {}),
          sx: {
            mt: 1
          },
...
var PasswordResetPage = function PasswordResetPage(_a) {
  ...
  // Create default footer with sign-in link
  var footerContent = footer || (signInUrl ? jsxRuntimeExports.jsxs(Typography, {
    variant: "body2",
    sx: {
      textAlign: 'center',
      mt: 2
    },
    children: ["Remember your password?", ' ', jsxRuntimeExports.jsx(Link, {
      href: signInUrl,
      children: "Sign in"
    })]
  }) : undefined);
...
var PasswordResetConfirmForm = function PasswordResetConfirmForm(_a) {
  ...
  return jsxRuntimeExports.jsx(Box, {
    ...
    children: jsxRuntimeExports.jsxs(GridLayout, {
      ...
      }), passwordStrength && formData.password && jsxRuntimeExports.jsxs(Box, {
        sx: {
          mt: 1
        },
        children: [jsxRuntimeExports.jsx(LinearProgress, {
...
var PasswordResetConfirmPage = function PasswordResetConfirmPage(_a) {
  ...
  // Create default footer with sign-in link
  var footerContent = footer || (signInUrl ? jsxRuntimeExports.jsx(Typography, {
    variant: "body2",
    sx: {
      textAlign: 'center',
      mt: 2
...
var RouteGuard = function RouteGuard(_a) {
  ...
  if (loading) {
    return jsxRuntimeExports.jsx(Box, {
      className: className,
      children: loadingComponent || jsxRuntimeExports.jsxs(Box, {
        sx: {
          display: 'flex',
  ...
  if (error) {
    return jsxRuntimeExports.jsx(Box, {
      className: className,
      children: errorComponent || jsxRuntimeExports.jsxs(Box, {
        sx: {
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
        ...
        }), showLoginButton && onRedirectToLogin && jsxRuntimeExports.jsx(Button, {
          variant: "contained",
          onClick: onRedirectToLogin,
          startIcon: jsxRuntimeExports.jsx(Login, {}),
  ...
  if (!user) {
    return jsxRuntimeExports.jsx(Box, {
      className: className,
      children: fallback || jsxRuntimeExports.jsxs(Box, {
        sx: {
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
...
var AuthRoutes = function AuthRoutes(_a) {
  ...
  var logo = useQwickApp().logo;
  // Add default auth routes if enabled
  var defaultAuthRoutes = enableDefaultAuthRoutes ? [jsxRuntimeExports.jsx(Route, {
  ...
  }, "auth-login"), jsxRuntimeExports.jsx(Route, {
  ...
  }, "auth-register"), jsxRuntimeExports.jsx(Route, {
...
var LogoutButton = function LogoutButton(_a) {
  ...
  var buttonIcon = icon || (showIcon ? jsxRuntimeExports.jsx(Logout, {}) : undefined);
 ...
 */
var logger$1 = getLogger('SupabaseAuthProvider');
/**
...
var SupabaseAuthProvider = /** @class */function () {
  ...
  SupabaseAuthProvider.prototype.convertError = function (error) {
    ...
    return createAuthError('PROVIDER_ERROR', message, {
      originalError: error
    });
  };
  /**
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            if (error) {
              ...
              return [2 /*return*/, createAuthFailure(this.convertError(error))];
            }
            if (!data.user) {
              logger$1.debug('No user returned from sign up');
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Sign up failed'))];
            }
            user = this.convertUser(data.user);
            logger$1.debug('User signed up successfully', {
              userId: user.id
            });
            return [2 /*return*/, createAuthSuccess(user)];
          case 3:
            error_3 = _b.sent();
            logger$1.error('Sign up error', {
              error: error_3
            });
            return [2 /*return*/, createAuthFailure(this.convertError(error_3))];
          case 4:
            return [2 /*return*/];
        }
      });
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            if (!data.session) {
              ...
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Sign in failed'))];
            }
            session = this.convertSession(data.session);
            logger$1.debug('User signed in successfully', {
              userId: session.user.id
            });
            return [2 /*return*/, createAuthSuccess(session)];
          case 3:
            error_4 = _b.sent();
            logger$1.error('Sign in error', {
              error: error_4
            });
            return [2 /*return*/, createAuthFailure(this.convertError(error_4))];
          case 4:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            ...
            return [2 /*return*/, createAuthSuccess({})];
          case 3:
            error_5 = _d.sent();
            logger$1.error('Social sign in error', {
              error: error_5
            });
            return [2 /*return*/, createAuthFailure(this.convertError(error_5))];
          case 4:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [2 /*return*/, createAuthSuccess(null)];
          case 3:
            error_6 = _a.sent();
            logger$1.error('Sign out error', {
              error: error_6
            });
            return [2 /*return*/, createAuthFailure(this.convertError(error_6))];
          case 4:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [2 /*return*/, createAuthFailure(this.convertError(error_7))];
          case 4:
            return [2 /*return*/];
        }
      });
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            if (!data.user) {
              ...
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Profile update failed'))];
            }
            user = this.convertUser(data.user);
          ...
          case 3:
            ...
            return [2 /*return*/, createAuthFailure(this.convertError(error_8))];
          case 4:
            return [2 /*return*/];
        }
      });
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            if (!data.session) {
              ...
              return [2 /*return*/, createAuthFailure(createAuthError('TOKEN_EXPIRED', 'Session refresh failed'))];
            }
            session = this.convertSession(data.session);
          ...
          case 3:
            ...
            return [2 /*return*/, createAuthFailure(this.convertError(error_9))];
          case 4:
            return [2 /*return*/];
        }
      });
 ...
 * Copyright © 2025 QwickApps.com. All rights reserved.
 */
var logger = getLogger('QwickAuthServiceClient');
/**
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            if (!response.ok) {
              ...
              return [2 /*return*/, createAuthFailure(data.error || {
                type: 'SIGN_IN_ERROR',
            ...
            return [2 /*return*/, createAuthSuccess(data.session)];
          case 3:
            error_2 = _a.sent();
            logger.error('Sign in error', {
              error: error_2
            });
            return [2 /*return*/, createAuthFailure({
              type: 'NETWORK_ERROR',
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [2 /*return*/, createAuthSuccess(data.user)];
          case 3:
            error_3 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 9:
            error_2 = _a.sent();
            authError = createAuthError('UNKNOWN_ERROR', error_2 instanceof Error ? error_2.message : 'Failed to get current session');
        ...
        switch (_a.label) {
          ...
          case 4:
            ...
            if (response.status !== 'OK') {
              ...
              return [2 /*return*/, createAuthFailure(createAuthError(errorType, errorMessage))];
            }
            return [4 /*yield*/, this.getCurrentSession()];
          case 5:
            session = _a.sent();
            if (!session) {
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Failed to create session'))];
            }
            this.notifyAuthStateChange(session);
            return [2 /*return*/, createAuthSuccess(session)];
          case 6:
            error_3 = _a.sent();
            return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', error_3 instanceof Error ? error_3.message : 'Sign in failed'))];
          case 7:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            session = _a.sent();
            if (!session) {
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Registration successful but session creation failed'))];
            }
            this.notifyAuthStateChange(session);
            return [2 /*return*/, createAuthSuccess(session.user)];
          case 6:
            error_4 = _a.sent();
            return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', error_4 instanceof Error ? error_4.message : 'Registration failed'))];
          case 7:
            return [2 /*return*/];
        }
      });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            error_5 = _a.sent();
            return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', error_5 instanceof Error ? error_5.message : 'Sign out failed'))];
          case 6:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            response = _a.sent();
            if (response.status !== 'OK') {
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Failed to send password reset email'))];
            }
            return [2 /*return*/, createAuthSuccess(null)];
          case 5:
            error_6 = _a.sent();
            return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', error_6 instanceof Error ? error_6.message : 'Password reset failed'))];
          case 6:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            response = _a.sent();
            if (!response.ok) {
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Failed to update profile'))];
            }
            return [4 /*yield*/, response.json()];
          case 4:
            user = _a.sent();
          ...
          case 5:
            error_7 = _a.sent();
            return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', error_7 instanceof Error ? error_7.message : 'Profile update failed'))];
          case 6:
            return [2 /*return*/];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            if (!_a.sent()) {
              return [2 /*return*/, createAuthFailure(createAuthError('TOKEN_EXPIRED', 'No active session'))];
            }
            return [4 /*yield*/, this.getCurrentSession()];
          case 5:
            session = _a.sent();
            if (!session) {
              return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', 'Failed to refresh session'))];
            }
            return [2 /*return*/, createAuthSuccess(session)];
          case 6:
            error_8 = _a.sent();
            return [2 /*return*/, createAuthFailure(createAuthError('UNKNOWN_ERROR', error_8 instanceof Error ? error_8.message : 'Session refresh failed'))];
          case 7:
            return [2 /*return*/];
        }
      });
  ...
  SuperTokensAuthProvider.prototype.signInWithProvider = function (options) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        return [2 /*return*/, createAuthFailure(createAuthError('NOT_IMPLEMENTED', 'Social login not yet implemented for SuperTokens'))];
      });
    });
  };
...
export { AccessGuard, AuthProvider, AuthRoutes, LoginForm, LoginPage, LogoutButton, PasswordResetConfirmForm, PasswordResetConfirmPage, PasswordResetForm, PasswordResetPage, QWICKAPPS_AUTH_CLIENT_VERSION, QwickAuthServiceClient, RegisterForm, RegisterPage, RouteGuard, SignInFooterLink, SignUpFooterLink, SocialAuthBlock, SocialLoginButton, SupabaseAuthProvider, SuperTokensAuthProvider, createAuthConfig, createSuperTokensProvider, AuthProvider as default, useAuth, useHasAnyRole, useHasRole, useIsAuthenticated };
